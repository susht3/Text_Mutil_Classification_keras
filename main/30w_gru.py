...
from util import plot_loss_figure, load_X, load_Y,load_X_hierarchical, n_hot_decoder, unique
...
def main():
	...
	save_dir = '../model/att_' + str(datetime.now()).split('.')[0].split()[0] + '/' # model is saved corresponding to the datetime
	...
	weights_file_path = '../model_30w/gru_2016-12-30/weights.15-0.041.h5'
	#weights_file_path = '../model_30w/blstm_attention_2016-12-16/weights.09-0.049.h5'
