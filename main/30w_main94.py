...
from gru2 import build_cnn_bgru
...
def main():
	...
	save_dir = '../30w_weights/attention_' + str(datetime.now()).split('.')[0].split()[0] + '/' # model is saved corresponding to the datetime
	...
	weights_file_path = '../30w_weights/gru94_2017-01-05/weights.37-0.044.h5'
