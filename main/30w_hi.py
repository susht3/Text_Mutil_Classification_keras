...
def main():
	...
	save_dir = '../30w_weights/hi2_' + str(datetime.now()).split('.')[0].split()[0] + '/' # model is saved corresponding to the datetime
	...
	#model = build_cnn_bgru(input_set_size, vector_size, max_sentence_len, label_set_size)	
